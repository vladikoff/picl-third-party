...
function MenubarOptions(options) {
  console.log('aaaaa');
...
let Menubar = Class({
  ...
  initialize: function(options) {
    options = menuitemNS(this).options = MenubarOptions(options);
...
function insertBefore(parent, insertBefore) {
  if (typeof insertBefore == "number") {
    switch (insertBefore) {
      case MenubarExport.FIRST_CHILD:
...
function MenubarExport(options) {
  return Menubar(options);
}
MenubarExport.FIRST_CHILD = 1;

exports.Menubar = MenubarExport;
